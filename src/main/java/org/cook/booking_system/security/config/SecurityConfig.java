    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/hotels/new", "/houses/new", "/rooms/new", "/room-types/new").hasAuthority("ROLE_ADMIN")
                        .requestMatchers("/hotels/*/edit", "/rooms/*/edit", "/houses/*/edit", "/room-types/**").hasAuthority("ROLE_ADMIN")
