    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/hotels/new", "/rooms/new", "/room-types/new").hasAnyAuthority("ROLE_ADMIN", "ROLE_HOTEL_KEEPER")
                        .requestMatchers("/hotels/*/**", "/rooms/*/**", "/room-types/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_HOTEL_KEEPER")
                        .requestMatchers("/houses/*/**", "/houses/new").hasAnyAuthority("ROLE_ADMIN", "ROLE_HOUSE_KEEPER")
