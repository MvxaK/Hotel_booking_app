...
public class HotelService {
    ...
    public Hotel createHotel(Hotel hotel){
        ...
        return hotelMapper.toModel(hotelEntity);
    }
    ...
    public Hotel updateHotel(Long id, Hotel hotelToUpdate){
        ...
        hotelEntity.setRooms(hotelToUpdate.getRooms().stream().map(roomMapper::toEntity).toList());

        logger.info("Hotel with id = {} is updated", id);
        return hotelMapper.toModel(hotelRepository.save(hotelEntity));
    }
